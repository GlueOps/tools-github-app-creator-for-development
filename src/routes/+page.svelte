...
<style>
	...
	.copy-btn{padding:.4rem .6rem;background:#238636;color:#fff;border:none;border-radius:4px;font-size:.75rem;cursor:pointer;white-space:nowrap;flex-shrink:0;width:auto;min-width:80px}
